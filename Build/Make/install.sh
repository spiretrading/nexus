...
apt-get update
apt-get install parallel gcc g++ gdb git cmake zip make mysql-server ruby python python-dev libtool libxml2 libxml2-dev libreadline6-dev libncurses5-dev vim nodejs nodejs-legacy npm <<< Y
