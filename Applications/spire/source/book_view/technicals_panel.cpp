...
technicals_panel::technicals_panel(QWidget* parent)
    : QWidget(parent) {
...
void technicals_panel::resizeEvent(QResizeEvent* event) {
...
void technicals_panel::set_labeled_data_long_form_text() {
...
void technicals_panel::set_labeled_data_short_form_text() {
