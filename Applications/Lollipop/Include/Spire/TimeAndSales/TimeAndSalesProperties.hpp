...
namespace Spire {
  ...
  void TimeAndSalesProperties::shuttle(S& shuttle,  unsigned int version) {
    shuttle.shuttle(
      "price_range_foreground_color", m_priceRangeForegroundColor);
    shuttle.shuttle(
      "price_range_background_color", m_priceRangeBackgroundColor);
    ...
    shuttle.shuttle(
      "horizontal_scroll_bar_visible", m_horizontalScrollBarVisible);
