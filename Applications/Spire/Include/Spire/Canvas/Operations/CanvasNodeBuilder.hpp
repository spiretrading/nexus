#ifndef SPIRE_CANVAS_NODE_BUILDER_HPP
#define SPIRE_CANVAS_NODE_BUILDER_HPP
#include <memory>
#include <string>
...
namespace Spire {
  ...
  /** Constructs a new CanvasNode from an existing CanvasNode. */
  class CanvasNodeBuilder {
    public:
       ...
       */
      explicit CanvasNodeBuilder(const CanvasNode& node);

      /** Returns the CanvasNode. */
      std::unique_ptr<CanvasNode> Make() const;
