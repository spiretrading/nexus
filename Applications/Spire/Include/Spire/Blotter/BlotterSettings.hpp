#ifndef SPIRE_BLOTTERSETTINGS_HPP
#define SPIRE_BLOTTERSETTINGS_HPP
...
namespace Spire {
  ...
  /*! \class BlotterSettings
      \brief Stores settings related to blotters.
   */
  class BlotterSettings : private boost::noncopyable {
    public:
      ...
      */
      typedef boost::signals2::signal<void (BlotterModel& model)>
        BlotterAddedSignal;
