...
namespace Spire {
  ...
  /**
   * Move the focus to the next or previous widget in the focus chain.
   * @param widget The starting widget from which to move the focus.
   * @param next If true, moves to the next widget; otherwise, moves to the
   *             previous widget.
   */
