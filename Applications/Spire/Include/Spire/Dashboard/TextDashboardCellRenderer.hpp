#ifndef SPIRE_TEXTDASHBOARDCELLRENDERER_HPP
#define SPIRE_TEXTDASHBOARDCELLRENDERER_HPP
#include <QFlags>
#include <QPen>
...
namespace Spire {
  ...
  /*! \class TextDashboardCellRenderer
      \brief Implements a DashboardCellRenderer that displays a text
             representation of its value.
   */
  class TextDashboardCellRenderer : public DashboardCellRenderer {
    public:

      //! Constructs a TextDashboardCellRenderer.
      /*!
        \param cell The cell to render.
        \param userProfile The user's profile.
      */
      TextDashboardCellRenderer(Beam::RefType<const DashboardCell> cell,
