...
namespace Spire {
  ...
  /*! \class CatalogSettings
      \brief Stores the user's catalog related settings.
   */
  class CatalogSettings : private boost::noncopyable {
    public:
      ...
      */
      typedef boost::signals2::signal<void (CatalogEntry& entry)>
        CatalogEntryAddedSignal;
      ...
      */
      typedef boost::signals2::signal<void (CatalogEntry& entry)>
        CatalogEntryRemovedSignal;

      //! Signals a CatalogTabModel was added.
      /*!
        \param tab The CatalogTabModel that was added.
      */
      typedef boost::signals2::signal<void (CatalogTabModel& tab)>
        CatalogTabModelAddedSignal;
      ...
      */
      boost::optional<CatalogEntry&> FindEntry(
      ...
      */
      ...
      const std::vector<std::unique_ptr<CatalogEntry>>& GetCatalogEntries()
        const;
      ...
      */
      void Replace(const CatalogEntry& oldEntry,
        std::unique_ptr<CatalogEntry>&& newEntry);

      //! Returns the list of CatalogTabModels.
      const std::vector<std::unique_ptr<CatalogTabModel>>& GetCatalogTabs()
        const;
