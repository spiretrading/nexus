...
TEST_SUITE("TokenParser") {
  TEST_CASE("basic") {
    ...
    REQUIRE(results.m_identifiers.size() == 6);
    ...
    REQUIRE(results.m_identifiers[3].m_value == "medium");
    REQUIRE(results.m_identifiers[3].m_column_number == 37);
    REQUIRE(results.m_identifiers[4].m_value == "bold");
    REQUIRE(results.m_identifiers[4].m_column_number == 45);
    REQUIRE(results.m_identifiers[5].m_value == "b");
    REQUIRE(results.m_identifiers[5].m_column_number == 60);
    REQUIRE(results.m_keywords.size() == 0);
  ...
  TEST_CASE("parse_multiple_lines") {
    ...
    REQUIRE(results.m_identifiers.size() == 9);
    ...
    REQUIRE(results.m_identifiers[2].m_value == "regular");
    REQUIRE(results.m_identifiers[2].m_line_number == 2);
    REQUIRE(results.m_identifiers[2].m_column_number == 20);
    REQUIRE(results.m_identifiers[3].m_value == "black");
    REQUIRE(results.m_identifiers[3].m_line_number == 2);
    REQUIRE(results.m_identifiers[3].m_column_number == 42);
    REQUIRE(results.m_identifiers[4].m_value == "border_color");
    REQUIRE(results.m_identifiers[4].m_line_number == 3);
    REQUIRE(results.m_identifiers[4].m_column_number == 8);
    REQUIRE(results.m_keywords.size() == 2);
    REQUIRE(results.m_keywords[0].m_value == Keyword::PX);
    REQUIRE(results.m_keywords[0].m_line_number == 2);
    REQUIRE(results.m_keywords[0].m_column_number == 30);
    REQUIRE(results.m_keywords[1].m_value == Keyword::MS);
    REQUIRE(results.m_keywords[1].m_line_number == 3);
    REQUIRE(results.m_keywords[1].m_column_number == 50);
