...
void RangeInputSlider::mouseMoveEvent(QMouseEvent* event) {
  ...
  if(m_is_dragging_handle) {
    ...
    m_min_changed_signal(rounded_value(m_current_min_value));
    m_current_max_value = map_x_to_value(m_max_handle_x);
    m_max_changed_signal(rounded_value(m_current_max_value));
...
void RangeInputSlider::resizeEvent(QResizeEvent* event) {
  move_handle(rounded_value(m_current_min_value), m_min_handle_x);
  move_handle(rounded_value(m_current_max_value), m_max_handle_x);
}
