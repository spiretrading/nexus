...
QWidget* DashboardWindowSettings::Reopen(Ref<UserProfile> userProfile) const {
...
void DashboardWindowSettings::Apply(
  ...
  m_dashboardWidgetSettings->Apply(
    Ref(userProfile), out(*window.m_ui->m_dashboard));
}
