...
UiViewerWindow::UiViewerWindow(QWidget* parent)
  ...
  add(make_check_button_menu_item_profile());
  ...
  add(make_link_menu_item_profile());
  ...
  add(make_scope_box_profile());
  add(make_scope_drop_down_box_profile());
  add(make_scope_filter_panel_profile());
  add(make_scope_list_item_profile());
