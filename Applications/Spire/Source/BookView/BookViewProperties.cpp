...
BookViewProperties::BookViewProperties() {
  ...
  get_book_quote_background_colors().push_back(QColor("#FFFFFF"));
  get_book_quote_background_colors().push_back(QColor("#EDE7FF"));
  get_book_quote_background_colors().push_back(QColor("#DBCFFF"));
  get_book_quote_background_colors().push_back(QColor("#C9B7FF"));
  get_book_quote_background_colors().push_back(QColor("#AA8FFF"));
  get_book_quote_background_colors().push_back(QColor("#9877FF"));
  get_book_quote_background_colors().push_back(QColor("#8760FF"));
