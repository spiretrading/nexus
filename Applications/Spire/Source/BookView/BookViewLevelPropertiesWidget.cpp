...
BookViewLevelPropertiesWidget::BookViewLevelPropertiesWidget(
  ...
  m_show_grid_lines_checkbox = new CheckBox(this);
  m_show_grid_lines_checkbox->set_label(tr("Show Grid"));
  m_show_grid_lines_checkbox->get_model()->set_current(
...
void BookViewLevelPropertiesWidget::apply(
  ...
  properties.set_show_grid(
    m_show_grid_lines_checkbox->get_model()->get_current());
