...
TimeAndSalesPropertiesDialog::TimeAndSalesPropertiesDialog(
  ...
  m_show_grid_checkbox = new CheckBox(this);
  m_show_grid_checkbox->set_label(tr("Show Grid"));
...
TimeAndSalesProperties
  ...
  properties.m_show_grid = m_show_grid_checkbox->get_model()->get_current();
...
void TimeAndSalesPropertiesDialog::set_properties(
  ...
  m_show_grid_checkbox->get_model()->set_current(m_properties.m_show_grid);
}
