...
KeyBindingsWindow::KeyBindingsWindow(QWidget* parent)
  ...
  auto interactions_form =
    new InteractionsKeyBindingsForm(Region::Global(), std::make_shared<InteractionsKeyBindingsModel>());
  ...
  scroll_box_body->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
