...
TEST_SUITE("TrendLineModel") {
  TEST_CASE("creating_and_getting_trend_lines") {
  ...
  TEST_CASE("removing_trend_lines") {
    auto model = TrendLineModel();
    auto line1 = make_line(10, 10, 20, 20, Qt::red, TrendLineStyle::SOLID);
    auto id1 = model.add(line1);
    auto line2 = make_line(30, 30, 40, 40, Qt::red, TrendLineStyle::SOLID);
  ...
  TEST_CASE("updating_and_getting_trend_lines") {
    auto model = TrendLineModel();
    auto line1 = make_line(10, 10, 20, 20, Qt::red, TrendLineStyle::SOLID);
    auto id1 = model.add(line1);
    auto line2 = make_line(30, 30, 40, 40, Qt::red, TrendLineStyle::SOLID);
  ...
  TEST_CASE("setting and getting_selected_status") {
    auto model = TrendLineModel();
    auto line1 = make_line(10, 10, 20, 20, Qt::red, TrendLineStyle::SOLID);
    auto id1 = model.add(line1);
    auto line2 = make_line(30, 30, 40, 40, Qt::red, TrendLineStyle::SOLID);
  ...
  TEST_CASE("closest_vertical_line") {
    auto model = TrendLineModel();
    auto line1 = make_line(10, 10, 20, 20, Qt::red, TrendLineStyle::SOLID);
    auto id1 = model.add(line1);
    auto line2 = make_line(30, 10, 40, 20, Qt::red, TrendLineStyle::SOLID);
  ...
  TEST_CASE("closest_horizontal_line") {
    auto model = TrendLineModel();
    auto line1 = make_line(10, 10, 20, 20, Qt::red, TrendLineStyle::SOLID);
    auto id1 = model.add(line1);
    auto line2 = make_line(30, 10, 40, 20, Qt::red, TrendLineStyle::SOLID);
