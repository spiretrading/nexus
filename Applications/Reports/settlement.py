...
def main():
  ...
  service_locator_client = beam.service_locator.ServiceLocatorClient(username,
    password, address)
  administration_client = nexus.ServiceAdministrationClient(
    service_locator_client)
  definitions_client = nexus.ServiceDefinitionsClient(service_locator_client)
  order_execution_client = nexus.ServiceOrderExecutionClient(
    service_locator_client)
