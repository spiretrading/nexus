...
interface Properties {
  ...
  /** The height of the HBoxLayout, leaving this value empty results in a
   *  height equal to the height of its content.
   */
  height?: number | string;

  /** The unique id of the HBoxLayout HTML element. */
  id?: string;

  /** Specifies the CSS class of the HBoxLayout HTML element. */
  className?: string;
 ...
 *  side-by-side. */
export class HBoxLayout extends React.Component<Properties> {
  ...
  public render(): JSX.Element {
    return (
      <BoxLayout width={this.props.width} height={this.props.height}
          ...
          orientation={BoxLayout.Orientation.HORIZONTAL}
          style={this.props.style} container={this.props.container}>
        {this.props.children}
      </BoxLayout>);
  }
}
