...
export QT_GIF_LIBRARY_DEBUG_PATH=$QT_LIBRARY_DEBUG_PATH/../plugins/imageformats/libqgif.a
export QT_GIF_LIBRARY_OPTIMIZED_PATH=$QT_LIBRARY_DEBUG_PATH/../plugins/imageformats/libqgif.a
...
export QT_SVG_ICON_PLUGIN_LIBRARY_DEBUG_PATH=$QTDIR/plugins/iconengines/libqsvgicon.a
export QT_SVG_ICON_PLUGIN_LIBRARY_OPTIMIZED_PATH=$QTDIR/plugins/iconengines/libqsvgicon.a
export QT_SVG_LIBRARY_DEBUG_PATH=$QT_LIBRARY_OPTIMIZED_PATH/libQt5Svg.a
export QT_SVG_LIBRARY_OPTIMIZED_PATH=$QT_LIBRARY_OPTIMIZED_PATH/libQt5Svg.a
