...
TEST_SUITE("ExecutionReportPublisher") {
  TEST_CASE("single_order_single_report") {
    ...
    auto fields = make_limit_order_fields(
      DirectoryEntry::make_account(1, "test"), parse_ticker("TST.TSX"),
      Side::BID, "TSX", Quantity(100), Money::ONE);
  ...
  TEST_CASE("single_order_multiple_reports") {
    auto timestamp = time_from_string("2024-07-21 10:00:00.000");
    auto fields = make_limit_order_fields(
      DirectoryEntry::make_account(2, "test"), parse_ticker("TST.TSX"),
      Side::ASK, "TSX", Quantity(200), Money::ONE);
  ...
  TEST_CASE("multiple_orders_single_report_each") {
    ...
    auto fields1 = make_limit_order_fields(
      DirectoryEntry::make_account(3, "test"), parse_ticker("AAA.TSX"),
      Side::BID, "TSX", Quantity(50), Money::ONE);
    auto fields2 = make_limit_order_fields(
      DirectoryEntry::make_account(4, "test"), parse_ticker("BBB.TSX"),
      Side::ASK, "TSX", Quantity(75), Money::ONE);
