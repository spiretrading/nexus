...
TEST_SUITE("message") {
  ...
  TEST_CASE("make_plain_text") {
    auto body = Nexus::Message::Body::make_plain_text("sample");
    REQUIRE(body.m_content_type == "text/plain");
    REQUIRE(body.m_message == "sample");
  }

  TEST_CASE("shuttle") {
    auto bodies = std::vector<Nexus::Message::Body>();
    bodies.push_back(Nexus::Message::Body::make_plain_text("first"));
    bodies.push_back(Nexus::Message::Body::make_plain_text("second"));
    auto message = Nexus::Message(5, DirectoryEntry::make_account(10, "user"),
