...
TEST_SUITE("VenueEntry") {
  TEST_CASE("publish_order_imbalance") {
    ...
    auto imbalance = OrderImbalance(parse_ticker("TST.TSX"),
      Side::BID, 100, Money::ONE, time_from_string("2024-07-10 00:00:01"));
    ...
    auto imbalance2 = OrderImbalance(parse_ticker("TST.TSX"),
      Side::ASK, 200, Money::ONE, time_from_string("2024-07-10 00:00:02"));
  ...
  TEST_CASE("load_initial_sequences") {
    ...
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("A.TSX"), Side::BID, 100, Money::ONE,
        time_from_string("2024-07-10 12:00:00")), TSX), Beam::Sequence(5)));
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("B.TSX"), Side::ASK, 200, Money::ONE,
        time_from_string("2024-07-10 12:00:01")), TSX), Beam::Sequence(3)));
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("C.TSX"), Side::BID, 150, Money::ONE,
        time_from_string("2024-07-10 12:00:02")), TSX), Beam::Sequence(7)));
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("D.ASX"), Side::BID, 300, Money::ONE,
        time_from_string("2024-07-10 12:00:00")), ASX), Beam::Sequence(15)));
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("E.ASX"), Side::ASK, 400, Money::ONE,
        time_from_string("2024-07-10 12:00:01")), ASX), Beam::Sequence(18)));
    data_store.store(SequencedValue(IndexedValue(
      OrderImbalance(parse_ticker("F.ASX"), Side::BID, 500, Money::ONE,
