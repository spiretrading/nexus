...
TEST_SUITE("SecuritySnapshot") {
  TEST_CASE("shuttle") {
    ...
    snapshot.m_bbo_quote = SequencedBboQuote(BboQuote(
      Quote(50 * Money::CENT, 213, Side::BID),
      Quote(55 * Money::CENT, 312, Side::ASK),
      time_from_string("2021-02-25 15:30:05.000")), Queries::Sequence(20000));
    snapshot.m_time_and_sale = SequencedTimeAndSale(
      TimeAndSale(time_from_string("2021-01-12 15:30:05.000"), Money(42), 123,
        ...
        "B42", "S12"), Queries::Sequence(30000));
