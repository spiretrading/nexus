...
TEST_SUITE("ServiceMarketDataFeedClient") {
  ...
  TEST_CASE("order_add_and_remove") {
    ...
    fixture.m_client->add_order(ticker, TSX, "MP1", true, order_id, Side::BID,
      Money::ONE, 100, time_from_string("2024-07-15 12:00:00"));
    fixture.m_client->remove_order(
      order_id, time_from_string("2024-07-15 12:00:01"));
    fixture.m_client->publish(bbo_quote);
    fixture.m_sampling_timer.trigger();
    completion_token.get();
  }
  ...
  TEST_CASE("order_aggregation") {
    ...
    fixture.m_client->add_order(
      ticker, TSX, mpid, true, "1", Side::BID, price, 100, timestamp1);
    fixture.m_client->add_order(
      ticker, TSX, mpid, true, "2", Side::BID, price, 200, timestamp2);
    fixture.m_sampling_timer.trigger();
    completion_token.get();
  }
  ...
  TEST_CASE("order_modify_size") {
    ...
    fixture.m_client->add_order(ticker, ASX, mpid, true, order_id, Side::BID,
      price, 100, timestamp1);
  ...
  TEST_CASE("publish_time_and_sale") {
    ...
    auto time_and_sale2 = TickerTimeAndSale(
      TimeAndSale(time_from_string("2024-07-15 12:00:01"), 2 * Money::ONE,
        200, TimeAndSale::Condition(), "TSX", "", ""), ticker);
    auto time_and_sale3 = TickerTimeAndSale(
      TimeAndSale(time_from_string("2024-07-15 12:00:02"), 3 * Money::ONE,
        300, TimeAndSale::Condition(), "TSX", "", ""), ticker);
    auto completion_token = Async<void>();
    fixture.on_message<SendMarketDataFeedMessages>(
      [&] (auto& client, const auto& messages) {
        REQUIRE(messages.size() == 3);
