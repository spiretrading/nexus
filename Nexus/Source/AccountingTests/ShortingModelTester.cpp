...
TEST_SUITE("ShortingModel") {
  ...
  TEST_CASE("multiple_ask_orders_accumulate_pending_and_trigger_short") {
    ...
    model.update(bid_report);
    auto ask_fields1 =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 60, Money::ONE);
  ...
  TEST_CASE("update_bid_order_increases_position") {
    ...
    model.update(bid_report);
    auto ask_fields =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 100, Money::ONE);
    REQUIRE(!model.submit(2, ask_fields));
  }
  ...
  TEST_CASE("update_ask_order_decreases_position_and_pending") {
    ...
    model.update(bid_report);
    auto ask_fields =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 80, Money::ONE);
    ...
    auto ask_fields2 =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 30, Money::ONE);
    REQUIRE(model.submit(3, ask_fields2));
  }
  ...
  TEST_CASE("update_terminal_status_clears_pending") {
    ...
    auto ask_fields2 =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 10, Money::ONE);
  ...
  TEST_CASE("submit_and_update_multiple_orders_mixed_sides") {
    ...
    model.update(ask_report);
    auto bid_fields2 =
      make_limit_order_fields(security, CAD, Side::BID, "TSX", 25, Money::ONE);
  ...
  TEST_CASE("update_with_unknown_order_id_no_effect") {
    ...
    auto ask_fields2 =
      make_limit_order_fields(security, CAD, Side::ASK, "TSX", 1, Money::ONE);
    REQUIRE(model.submit(2, ask_fields2));
  }
}
