#ifndef NEXUS_RISKSTATE_HPP
#define NEXUS_RISKSTATE_HPP
...
namespace Details {
  ...
  /*! \struct RiskState
      \brief Stores the risk monitoring state of an account.
    */
  struct RiskState {
    ...
    */
    RiskState(Type type, const boost::posix_time::ptime& expiry);
  ...
  inline RiskState::RiskState(Type type, const boost::posix_time::ptime& expiry)
      : m_type(type),
        m_expiry(expiry) {}
