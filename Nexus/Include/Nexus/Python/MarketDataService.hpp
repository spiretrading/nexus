...
namespace Nexus::Python {
  ...
  auto export_market_data_client(
    ...
    auto client = pybind11::class_<C>(module, name.data()).
      def("query_sequenced_order_imbalances",
        pybind11::overload_cast<const VenueQuery&,
      ...
      def("load_session_technicals", &C::load_session_technicals).
  ...
  auto export_market_data_feed_client(
    ...
    auto client = pybind11::class_<C>(module, name.data()).
      ...
      def("publish",
        pybind11::overload_cast<const TickerBboQuote&>(&C::publish)).
      def("publish",
  ...
  /**
   * Exports the OrderToBboQuoteModel class with string order identifiers.
   * @param module The module to export to.
   */
  void export_order_to_bbo_quote_model(pybind11::module& module);
