...
namespace Nexus {
  ...
  struct OrderFields {
     ...
     */
    OrderFields(Beam::DirectoryEntry account, Ticker ticker,
   ...
   * @param price The price of the Order.
   */
  inline OrderFields make_limit_order_fields(Ticker ticker, CurrencyId currency,
   ...
   * @param quantity The quantity to order.
   */
  inline OrderFields make_market_order_fields(Ticker ticker,
