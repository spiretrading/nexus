#ifndef NEXUS_ORDEREXECUTIONSESSION_HPP
#define NEXUS_ORDEREXECUTIONSESSION_HPP
...
namespace OrderExecutionService {
  ...
  /*! \class OrderExecutionSession
      \brief Stores session info for an OrderExecutionServlet client.
   */
  class OrderExecutionSession
    ...
    public:
      ...
      */
      ...
      //! Returns <code>true</code> iff this session belongs to an
      //! administrator.
      ...
      */
      ...
      //! Grants authorization to execute Orders for a specified account.
