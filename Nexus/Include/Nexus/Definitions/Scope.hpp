...
namespace Nexus {
  ...
  class Scope {
    public:
      ...
      /**
       * Returns <code>true</code> iff <i>this</i> Scope is a subset of another.
       */
      bool operator <=(const Scope& scope) const;
  ...
  inline bool Scope::operator ==(const Scope& scope) const {
    return std::tie(m_is_global, m_countries, m_venues, m_tickers) == std::tie(
      scope.m_is_global, scope.m_countries, scope.m_venues, scope.m_tickers);
  }
