#ifndef NEXUS_BINARYSEQUENCEPROTOCOLMESSAGE_HPP
#define NEXUS_BINARYSEQUENCEPROTOCOLMESSAGE_HPP
#include <cstdint>
...
namespace BinarySequenceProtocol {
  ...
  inline BinarySequenceProtocolMessage BinarySequenceProtocolMessage::Parse(
    ...
    static const auto HEADER_LENGTH = LENGTH_LENGTH;
    if(size < HEADER_LENGTH) {
      BOOST_THROW_EXCEPTION(
        BinarySequenceProtocolParserException{"Packet too short."});
    }
    BinarySequenceProtocolMessage message;
